                ...
                <div class="card border-0 shadow mb-4">
                    ...
                    <div class="card-body  p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" placeholder="Enter Name" class="form-control" value="{{@Auth::user()->name}}" name="name">
                        </div>
                        <div class="mb-4">
                            <label for="" class="mb-2">Email*</label>
                            <input type="text" placeholder="Enter Email" class="form-control" value="{{@Auth::user()->email}}" name="email">
                        </div>
                        <div class="mb-4">
                ...
                <div class="card border-0 shadow mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" placeholder="Old Password" class="form-control" name="current_password>
                        </div>
                        <div class="mb-4">
